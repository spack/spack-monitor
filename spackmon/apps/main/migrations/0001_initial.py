    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "platform",
                    models.CharField(
                        help_text="The platform (e.g., linux)", max_length=50
                    ),
                ),
                (
                    "platform_os",
                    models.CharField(
                        help_text="The platform operating system", max_length=50
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "build",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="main.build"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="The compiler name", max_length=50),
                ),
                (
                    "version",
                    models.CharField(
                        help_text="The compiler version string", max_length=50
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dependency_type",
                    models.JSONField(
                        default=list, help_text="The dependency type, e.g., build run"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of the feature", max_length=50
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "spack_version",
                    models.CharField(help_text="The version of spack", max_length=250),
                ),
                (
                    "full_hash",
                    models.CharField(
                        blank=True, help_text="The full hash", max_length=50, null=True
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="The spec name (without version)", max_length=250
                    ),
                ),
                (
                    "build_hash",
                    models.CharField(
                        blank=True, help_text="The build hash", max_length=50, null=True
                    ),
                ),
                ...
                (
                    "package_hash",
                    models.CharField(
                        blank=True, help_text="The spec hash", max_length=250, null=True
                    ),
                ),
                (
                    "namespace",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ftype",
                    models.CharField(
                        blank=True, help_text="The type of install file", max_length=25
                    ),
                ),
                ...
                (
                    "hash",
                    models.CharField(
                        help_text="The hash of the object", max_length=250
                    ),
                ),
                (
                    "build",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.TextField(help_text="The value of the environment variable"),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="main.spec"
            ),
        ),
        migrations.CreateModel(
            name="BuildWarning",
            fields=[
                ...
                (
                    "source_file",
                    models.CharField(help_text="The source file.", max_length=150),
                ),
                (
                    "source_line_no",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hostname",
                    models.CharField(help_text="The hostname", max_length=150),
                ),
                ("platform", models.CharField(help_text="The platform", max_length=50)),
                (
                    "kernel_version",
                    models.CharField(help_text="The kernel version", max_length=150),
                ),
        ...
        migrations.AddField(
            ...
            name="target",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="main.target"
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of the attribute", max_length=150
                    ),
                ),
                (
                    "analyzer",
                ...
                (
                    "value",
                    models.TextField(
                        blank=True, help_text="A text based value", null=True
                    ),
                ),
                (
                    "binary_value",
                    models.BinaryField(
                        blank=True, help_text="A binary value", null=True
                    ),
                ),
                (
                    "install_file",
